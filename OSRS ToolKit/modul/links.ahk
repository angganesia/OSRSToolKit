...
gitHub := "https://github.com/angganesia"
fiverr := ""
...
link_addAsGroupBox(guiName){
	...
	PicturesWidth := (0*40) + 10 ;3 pics * 40width/each
	xIni := round((GBWidth/2) - (PicturesWidth/2))
	Gui, %guiName%:Add,Picture,x%xIni%+10 yp+15 w40 h40 gcontentToClipboard vcontrolPicGitHub, %A_WorkingDir%/img/git_logo_48.png
