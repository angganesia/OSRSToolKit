...
createGuiInfo(infotxt){
	...
	#Include, modul/gui.exe
	;GUI
	;Gui, info:New, -Resize +MinimizeBox -MaximizeBox +HwndGuiHwnd, OSRS ToolKit %version%
	;Gui, info:show, NA
...
if FileExist(infotxt){
	...
	Gui, Font , , Verdana
	Gui, info:add, Edit, T16  w600  h240 0x80 ReadOnly cWhite 0x40,  %FileContents%
